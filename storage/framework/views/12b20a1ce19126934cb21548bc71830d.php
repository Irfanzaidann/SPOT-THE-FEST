<nav class="navbar navbar-expand-lg container">
        ...
        <?php if($logged): ?>
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-4 d-flex align-items-center gap-4 gap-lg-0">
            ...
            <li class="nav-item nav-logout">
              <span href="#">
                <img src="/images/<?php echo e($photo); ?>" alt="foto profil" style="width: 40px; height: 40px; object-fit: cover" class="rounded-circle">
              </span>
  ...
  </nav><?php /**PATH D:\xampp\htdocs\spot-the-fest\resources\views/components/navbar.blade.php ENDPATH**/ ?>